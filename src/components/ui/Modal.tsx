          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="flex items-start justify-between">
              ...
              {showCloseButton && (
                <button
                  onClick={onClose}
                  className="ml-3 flex-shrink-0 h-7 w-7 flex items-center justify-center rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
